...
{Este metodo carrega as informações de conexão com o banco de ddos
 de um arquivo .ini de configuração que fica na pasta do sistema}
...
procedure TFwkDmPadraoDatabase.DataModuleDestroy(Sender: TObject);
begin
  FDConnection.Connected := False;
end;
